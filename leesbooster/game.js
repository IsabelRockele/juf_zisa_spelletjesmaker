(() => {
  ...
  const game={family:'combinaties',goals:['wr'],words:[],events:[],index:0,timer:null,remaining:0,paused:false,currentDuration:0,currentStart:0,lastConfig:null};
  ...
  function back(){clearTimeout(game.timer);$('#gameStage').hidden=true;$('#gameSetup').hidden=false;game.paused=false}
