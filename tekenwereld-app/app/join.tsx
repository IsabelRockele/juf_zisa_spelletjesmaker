...
export default function Join(){
 const [code,setCode]=useState(''),[entry,setEntry]=useState(''),[world,setWorld]=useState(''),[error,setError]=useState(''),[busy,setBusy]=useState(false),[sent,setSent]=useState('');
 const request=useRef(0),activeCode=useRef('');
 function clear(){activeCode.current='';setCode('');setWorld('');setSent('');setError('');}
