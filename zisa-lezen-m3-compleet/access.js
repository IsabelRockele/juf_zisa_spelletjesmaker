(()=>{
  ...
  const start=()=>{gate.remove();const style=document.querySelector('link[href^="style.css"]');if(style)style.href='style.css?v=38';const script=document.createElement('script');script.src='app.js?v=45';document.body.append(script)};
