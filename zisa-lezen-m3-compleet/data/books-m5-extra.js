...
(() => {
  ...
  const mand = n => [6,7,8,10,12].includes(n) ? img('m5-lege-mand', n).replace('.webp','-v2.webp') : img('m5-lege-mand', n);
  ...
  window.ZISA_BOOKS.push({
    ...
    pages:[
      ...
      page('Samen tillen ze de bank aan beide kanten op.\nDe schuur staat verderop, aan het einde van het pad.\nDaar zetten ze de bank naast een lange tafel.',mand(2),choice('Waarom gaat Haas met Egel mee?',['Hij wil een nieuwe mand kopen.','Hij helpt om een bank te dragen.','Hij wil alle noten alleen opeten.'],1,'Lees wat Egel hem vraagt.')),
      ...
      page('Vos staat bij een boom en schudt de regen van zijn jas.\n‘Ik heb je noten niet meegenomen,’ vertelt hij.\n‘Ik zag Eekhoorn wel met een kar naar de schuur rijden.’\nHaas bedankt hem voor de aanwijzing.',mand(6),choice('Waarom bewijst het plukje vacht niet dat Vos de noten meenam?',['Eekhoorn heeft ook een roodbruine vacht.','Vos draagt nooit een jas.','De mand stond in de schuur.'],0,'Denk aan wat Egel over de kleur zegt.')),
      page('In de zachte aarde lopen twee smalle wielsporen.\nHaas en Egel volgen de sporen over het pad.\nZe eindigen bij de blauwe deur van de schuur.',mand(7)),
      page('Naast de deur staat een kleine houten kar.\nOp de grond liggen twee hazelnoten.\nDan horen ze binnen een kort, scherp gekraak.\nHaas klopt aan voordat hij de deur opent.',mand(8),choice('Welke aanwijzingen vinden Haas en Egel bij de schuur?',['Een sjaal en een lege tafel.','Een houten kar en twee hazelnoten.','Een rode jas en een kapotte bank.'],1,'Kijk wat er naast de deur staat en ligt.')),
      ...
      page('Haas vertelt Vos dat de noten terecht zijn.\n‘Dank je dat je ons verder hielp,’ zegt hij.\n‘Gelukkig hebben we eerst gevraagd wat er gebeurd was.’\nVos glimlacht en brengt appels naar de schuur.',mand(13)),
