document.addEventListener("DOMContentLoaded", function() {
  ...
  function init() {
    ...
    // Info modal – gratis versie (infoBtn/infoModal); pro versie gebruikt help-modal via classList
    var infoBtn = document.getElementById("infoBtn");
    var infoModal = document.getElementById("infoModal");
    var infoModalClose = document.getElementById("infoModalClose");
    if (infoBtn && infoModal) {
      infoBtn.addEventListener("click", function() { infoModal.style.display = "flex"; });
    }
    if (infoModalClose && infoModal) {
      infoModalClose.addEventListener("click", function() { infoModal.style.display = "none"; });
      infoModal.addEventListener("click", function(e) { if (e.target === this) this.style.display = "none"; });
    }
