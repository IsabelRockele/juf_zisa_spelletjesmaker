...
const discoverFolderAllowed=folder==='prototype_leerjaar4'||folder==='prototype_breuken4'||folder==='splitsmachine';
...
const help=folder==='prototype_breuken4'?null:folder==='splitsmachine'?{title:'De Splitsmachine',steps:[['👀','Kijk naar de splitsing.'],['🧠','Zoek welk getal ontbreekt.'],['⚡','Vul juist in en laad de machine op.']]}:helpByFile[file];
