...
const help=folder==='prototype_breuken4'
  ?{title:'De Breukenstudio',steps:[['🧩','Kies eerst wat je met breuken wilt oefenen.'],['👆','Bouw, combineer of vergelijk de voorstelling.'],['✅','Klik alleen bij bouwopdrachten op Klaar.']]}
  :helpByFile[file];
