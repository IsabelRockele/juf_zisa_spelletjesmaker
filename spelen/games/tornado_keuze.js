document.addEventListener('DOMContentLoaded', () => {
    ...
    startSpelKnop.addEventListener('click', () => {
        ...
        // Sla de keuzes op voor het spel zelf
        localStorage.setItem('tornado_tafels', JSON.stringify(geselecteerdeTafels));
        localStorage.setItem('tornado_soort', geselecteerdeSoort);

        window.location.href = 'tornado.html'; // Changed to tornado_spel.html
    });
