document.addEventListener('DOMContentLoaded', () => {
    ...
    startSpelKnop.addEventListener('click', () => {
        ...
        localStorage.setItem('woestijnjacht_tafels', JSON.stringify(geselecteerdeTafels));
        localStorage.setItem('woestijnjacht_soort', geselecteerdeSoort);

        window.location.href = 'woestijnjacht_spel.html';
    });
