...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function genereerEnToon() {
    ...
    const detail = { driehoeken: huidigeDriehoeken, opties: pdfOpties(false) };
    window.RekendriehoekOntdekData = detail;
    document.dispatchEvent(new CustomEvent('rekendriehoek:updated', { detail }));
  }
