(function () {
  ...
  function renderRoutines(doc,root,data,bewerken,wijzig,opnieuw){
    ...
    const keuzes=[
      ...
      ['stoel-onder-tafel','Stoel onder de tafel'],['stoel-op-tafel','Stoel op de tafel'],['bakje-netjes','Bakje netjes leggen'],['bakje-in-kast','Bakje in de kast'],['bakje-uit-kast','Neem je groene bakje uit de kast'],
