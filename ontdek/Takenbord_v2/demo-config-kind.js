  ...
  function maakDemoBanner() {
    ...
    banner.innerHTML =
      '<div class="demo-banner-inner">' +
        ...
        '</span>' +
        '<a href="../app.html" class="demo-banner-btn">' +
    ...
    var html =
      '<div class="demo-popup-overlay" id="demo-popup-current">' +
        '<div class="demo-popup-box">' +
          ...
          '<a href="https://demo.jufzisa.be/#zg-prijzen" class="demo-popup-btn-primary">' +
            'Meer over Spelgenerator →' +
          '</a>' +
  ...
  function installeerVerkoopTriggers() {
    ...
    backBtns.forEach(function(btn) {
      btn.onclick = function(e) {
        e.preventDefault();
        e.stopPropagation();
        window.location.href = 'klasbord.html';
      };
      if (btn.tagName === 'A') btn.href = 'klasbord.html';
      btn.textContent = '📋 Bekijk klasbord';
      ...
      window.showKindClosed = function() {
        ...
        overlay.innerHTML =
          '<div style="background:#fff;border-radius:24px;padding:32px 28px;max-width:420px;width:100%;box-shadow:0 12px 40px rgba(0,0,0,.1);text-align:center;font-family:\'Nunito\',sans-serif;">' +
            ...
            '</button>' +
            '<a href="klasbord.html" style="display:block;background:transparent;color:#64748b;text-decoration:underline;padding:8px;font-size:13px;font-family:inherit;">' +
              'Bekijk de klasbord-demo' +
            '</a>' +
          '</div>';
