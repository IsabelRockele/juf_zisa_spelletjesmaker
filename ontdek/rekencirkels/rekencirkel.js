document.addEventListener("DOMContentLoaded", function() {
  ...
  function renderPreviewCanvas() {
    ...
    document.dispatchEvent(new CustomEvent("rekencirkel:updated"));
  }
  ...
  async function downloadPDF(opts) {
    ...
    if (opts.countOnly) return { pages: pages };
    if (!solutionsMode && window.OntdekTrial && window.OntdekTrial.authorizeDownload) {
  ...
  window.RekencirkelPdfEngine = {
    countPages: function() { return downloadPDF({ countOnly: true }); }
  };
