...
function _getSplitsConfig() {
  ...
  function selecteerRelatieRadio(naam, waarde, el) {
    ...
    el.classList.add('geselecteerd'); const radio=el.querySelector('input'); if(radio) radio.checked=true; if(naam==='rr-soort'){const aantal=document.getElementById('rr-aantal');if(aantal)aantal.value=waarde==='familie'?'6':waarde==='kader'?'3':'2';} _updateRelatieUI();
  }
