document.addEventListener('DOMContentLoaded', () => {
    ...
    const toolInfo = {potlood:{name:'Potlood',text:'Teken vrij op de rechterafbeelding.'},gum:{name:'Gum',text:'Kies een kleine of grote gom. De omtrek op de afbeelding toont precies wat wordt weggeveegd.'},select:{name:'Selecteren',text:'Sleep een kader rond een onderdeel dat je wilt kopiëren of verplaatsen.'},lijn:{name:'Lijn',text:'Trek een rechte lijn in de rechterafbeelding.'},cirkel:{name:'Cirkel',text:'Sleep om een cirkel of ovaal te tekenen.'},rechthoek:{name:'Rechthoek',text:'Sleep om een rechthoek te tekenen.'},pipet:{name:'Kleur kiezen',text:'Klik in de afbeelding om exact die kleur over te nemen.'},opvulemmer:{name:'Opvullen',text:'Klik in een vlak om het met de gekozen kleur te vullen.'},tekst:{name:'Tekst',text:'Vul tekst voor links en rechts in en klik daarna op de gewenste plaats.'}};
