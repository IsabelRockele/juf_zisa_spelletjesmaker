...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function genereerEnToon() {
    ...
    const detail = { piramides:huidigePiramides, opties:pdfOpties(false) };
    window.RekenpiramideOntdekData = detail;
    document.dispatchEvent(new CustomEvent('rekenpiramide:updated', { detail }));
  }
